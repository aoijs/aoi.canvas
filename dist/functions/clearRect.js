...
exports.default = {
    ...
    code: async (d) => {
        ...
        d.data.canvases.get(canvas)?.clearRect(parseFloat(x), parseFloat(y), parseFloat(width), parseFloat(height), (radius?.trim()?.startsWith("[") && radius?.trim().endsWith("]") ? JSON.parse(radius) : parseFloat(radius)));
        return {
