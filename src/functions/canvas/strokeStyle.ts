...
export default new AoiFunction<"djs">({
    name: "$strokeStyle",
    description: "Sets the stroke style in a canvas.",
    params: [
        {
            name: "canvas",
            description: "Name of the canvas to set the stroke style in.",
    ...
    code: async (ctx): Promise<any> => {
        ...
        if (!canvas)
            return ctx.aoiError.fnError(ctx, "custom", {}, "No canvas to set the stroke style in.");
